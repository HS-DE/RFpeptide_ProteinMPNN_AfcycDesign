...
"$PYTHON_BIN" '/mnt/c/SH/fga_cyclic_peptide_design/scripts/external/run_afcycdesign_independent_recovery.py' \
  --job-spec '/mnt/c/SH/fga_cyclic_peptide_design/results/rfpeptides_article_route_clean_20260623_stage5_batch01_batch02/07_structure_validation/inputs/job_specs/S5_04_batch02_RFpep_Site_2_1518_seed02.json' \
