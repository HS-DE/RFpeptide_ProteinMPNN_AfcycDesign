    ...
    """
        ...
        if self.preprocess_conf.d_t1d >= 24: # add hotspot residues
            ...
            if self.ppi_conf.hotspot_res is None:
                ...
                # Reuse the complex-global indices produced by
                # get_idx0_hotspots(). The receptor-local indices omit the
                # binder-length offset and silently mark the wrong residues.
                hotspot_idx = self.hotspot_0idx or []
